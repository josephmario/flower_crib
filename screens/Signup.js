...
export default function Signup({ google }) {
                ...
                >
                    {({ handleChange, handleBlur, handleSubmit, values }) => (
                        <View style={styles.StyleFormArea}>
                            ...
                            <View style={styles.ExtraView}><Text style={styles.ExtraText}>Already have an account?</Text>
                            <TouchableOpacity style={styles.TextLink}><Text style={styles.TextLinkContent}>Login</Text></TouchableOpacity></View>
                        </View>
                    )}
                </Formik>
            </View>
...
const MyTextInput = ({ label, icon, isPassword, hidePassword, setHidePassword, isDate, showDatePicker, onchangeText, onblur, value, ...props }) => {
    return (
        <View style={styles.InputWrapper}>
            ...
            {!isDate && <TextInput
                ...
                value={value}
            />}
            {isDate && <TouchableOpacity onPress={showDatePicker}><TextInput
                {...props}
                style={styles.StyleTextInput}
                onChangeText={onchangeText}
                onBlur={onblur}
